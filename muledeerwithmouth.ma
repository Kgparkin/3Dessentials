...
//Last modified: Sun, Jan 19, 2014 05:02:26 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 45.217230380912298 12.504610183682249 -0.14059286996261022 ;
	setAttr ".r" -type "double3" -9.3383527288362309 806.9999999999776 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 48.199399004991399;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 3.3298744880644056 -5.2193758849927638 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 21.714262586360604;
...
createNode transform -n "pCube2";
	...
	setAttr ".r" -type "double3" -4.6552594414776927 -8.8986482732103855 -5.6802549484625926 ;
...
connectAttr "polyCut34.out" "pCubeShape1.i";
