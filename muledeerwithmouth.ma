...
//Last modified: Fri, Jan 17, 2014 02:35:06 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.1288104378442831 11.487205117657522 17.233808953477837 ;
	setAttr ".r" -type "double3" -21.938352729144814 720.5999999998113 -1.3667195277901832e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 18.279659799363554;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 8.119444461810609 9.2452596059768393 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 0.52639561520958189;
...
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	...
	setAttr -s 4 ".pt[0:3]" -type "float3"  17.188372 -0.32328463 -0.30414459 
		17.188372 -0.32328463 -0.30414459 17.188372 -0.32328463 -0.30414459 17.188372 -0.32328463 
		-0.30414459;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 14 ".pt";
	setAttr ".pt[871]" -type "float3" 1.8626451e-09 1.4901161e-08 -2.9802322e-08 ;
	setAttr ".pt[872]" -type "float3" -3.7252903e-09 1.4901161e-08 4.4703484e-08 ;
	setAttr ".pt[873]" -type "float3" 0 2.2351742e-08 1.4901161e-08 ;
	setAttr ".pt[874]" -type "float3" -1.4901161e-08 3.7252903e-08 2.9802322e-08 ;
	setAttr ".pt[875]" -type "float3" 1.4901161e-08 -4.4703484e-08 1.4901161e-08 ;
	setAttr ".pt[876]" -type "float3" 1.4901161e-08 -2.9802322e-08 -1.0430813e-07 ;
	setAttr ".pt[877]" -type "float3" 0 -2.2351742e-08 -2.9802322e-08 ;
	setAttr ".pt[878]" -type "float3" 0 -2.9802322e-08 1.4901161e-08 ;
	setAttr ".pt[879]" -type "float3" -1.4901161e-08 7.4505806e-09 1.4901161e-08 ;
	setAttr ".pt[880]" -type "float3" 1.4901161e-08 -7.4505806e-09 8.9406967e-08 ;
	setAttr ".pt[881]" -type "float3" -1.4901161e-08 -5.2154064e-08 -5.9604645e-08 ;
	setAttr ".bw" 3;
...
createNode displayLayerManager -n "layerManager";
	setAttr ".cdl" 7;
	setAttr -s 9 ".dli[1:8]"  1 2 3 4 8 5 6 7;
	setAttr -s 9 ".dli";
...
createNode polyTweak -n "polyTweak40";
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[734]" -type "float3" 0 -0.12264638 0 ;
	setAttr ".tk[735]" -type "float3" 0 -0.12264638 0 ;
	setAttr ".tk[736]" -type "float3" 0 -0.12264638 0 ;
	setAttr ".tk[737]" -type "float3" 0 -0.12264638 0 ;
...
createNode polyTweak -n "polyTweak45";
	setAttr ".uopa" yes;
	setAttr -s 33 ".tk";
	setAttr ".tk[762]" -type "float3" -0.12711062 0.038926598 0 ;
	setAttr ".tk[763]" -type "float3" -0.1409533 0.040330648 0 ;
	setAttr ".tk[764]" -type "float3" -0.16365969 0.061246067 0 ;
	setAttr ".tk[765]" -type "float3" -0.17169821 0.095928058 0 ;
	setAttr ".tk[766]" -type "float3" -0.17109412 0.095050849 0 ;
	setAttr ".tk[767]" -type "float3" -0.18276894 0.089037895 0 ;
	setAttr ".tk[768]" -type "float3" -0.18711205 0.051151812 0 ;
	setAttr ".tk[769]" -type "float3" -0.19301562 -0.024235446 0 ;
	setAttr ".tk[770]" -type "float3" -0.13754418 0.014637578 0 ;
	setAttr ".tk[771]" -type "float3" -0.10211205 0.014637578 0 ;
	setAttr ".tk[772]" -type "float3" -0.00028603664 0.014637578 0 ;
	setAttr ".tk[773]" -type "float3" 0.10203802 0.014637578 0 ;
	setAttr ".tk[774]" -type "float3" 0.13754418 0.014637578 0 ;
	setAttr ".tk[775]" -type "float3" 0.20839855 -0.024235446 0 ;
	setAttr ".tk[776]" -type "float3" 0.20115012 0.051151801 0 ;
	setAttr ".tk[777]" -type "float3" 0.1958176 0.089037806 0 ;
	setAttr ".tk[778]" -type "float3" 0.18379661 0.095050745 0 ;
	setAttr ".tk[779]" -type "float3" 0.17816713 0.095928058 0 ;
	setAttr ".tk[780]" -type "float3" 0.16365969 0.061246067 0 ;
	setAttr ".tk[781]" -type "float3" 0.14069512 0.040330648 0 ;
	setAttr ".tk[782]" -type "float3" 0.12538588 0.038926546 0 ;
	setAttr ".tk[783]" -type "float3" 0.11508396 -0.011041964 0 ;
	setAttr ".tk[784]" -type "float3" 0.10797244 -0.041612789 0 ;
	setAttr ".tk[785]" -type "float3" 0.098468885 -0.095928058 0 ;
	setAttr ".tk[786]" -type "float3" 0.068072975 -0.035816438 0 ;
	setAttr ".tk[787]" -type "float3" 0.049550634 -0.035816438 0 ;
	setAttr ".tk[788]" -type "float3" -0.003828312 -0.035816438 0 ;
	setAttr ".tk[789]" -type "float3" -0.049589247 -0.035816438 0 ;
	setAttr ".tk[790]" -type "float3" -0.06807299 -0.035816438 0 ;
	setAttr ".tk[791]" -type "float3" -0.10002588 -0.095928058 0 ;
	setAttr ".tk[792]" -type "float3" -0.11018988 -0.041612837 0 ;
	setAttr ".tk[793]" -type "float3" -0.11779558 -0.011041964 0 ;
...
connectAttr "polyCut26.out" "pCubeShape1.i";
