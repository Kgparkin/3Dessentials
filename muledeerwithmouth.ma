...
//Last modified: Thu, Jan 16, 2014 01:12:21 AM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.8386711580610142 11.94101169245428 158.91894130802029 ;
	setAttr ".r" -type "double3" -1.53835272926649 362.59999999846235 2.4873689175957546e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 152.95144338441986;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 4.7474888752296902 3.2608573100491087 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 26.059497963571353;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 18 ".pt";
	setAttr ".pt[8]" -type "float3" 0 -0.27393329 0 ;
	setAttr ".pt[9]" -type "float3" 0 -0.27393329 0 ;
	setAttr ".pt[36]" -type "float3" -0.30006731 -0.44838974 0.69296604 ;
	setAttr ".pt[37]" -type "float3" -0.15785366 -0.22598897 0 ;
	setAttr ".pt[38]" -type "float3" 0.15785366 -0.22598897 0 ;
	setAttr ".pt[39]" -type "float3" 0.30006731 -0.44838974 0.69296604 ;
	setAttr ".pt[50]" -type "float3" 0 -0.25484335 0 ;
	setAttr ".pt[51]" -type "float3" 0 -0.25484335 0 ;
	setAttr ".pt[115]" -type "float3" 0 -0.14753187 0 ;
	setAttr ".pt[221]" -type "float3" -0.48845693 0 0 ;
	setAttr ".pt[233]" -type "float3" 0.48845693 0 0 ;
	setAttr ".pt[325]" -type "float3" 0.22689824 -0.25327235 0 ;
	setAttr ".pt[358]" -type "float3" -0.22689824 -0.25327235 0 ;
	setAttr ".pt[497]" -type "float3" 0 -0.014514344 -0.21771516 ;
	setAttr ".pt[499]" -type "float3" 0 -0.014514344 -0.21771516 ;
	setAttr ".bw" 3;
...
createNode polyTweak -n "polyTweak29";
	setAttr ".uopa" yes;
	setAttr -s 14 ".tk";
	setAttr ".tk[488]" -type "float3" 0 0 -0.20034797 ;
	setAttr ".tk[489]" -type "float3" 0 0 -0.20034797 ;
...
connectAttr "polyCut6.out" "pCubeShape1.i";
