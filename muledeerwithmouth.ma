...
//Last modified: Fri, Jan 17, 2014 10:46:15 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 30.245827957850128 8.930171574429842 -8.9021153578534875 ;
	setAttr ".r" -type "double3" -7.5383527300503612 818.59999999985394 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 30.103894519105612;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 4.9117203786283401 -5.0489722221894615 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 21.658106371557135;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 113 ".pt";
	setAttr ".pt[6]" -type "float3" 0 0 0.57873183 ;
	setAttr ".pt[7]" -type "float3" 0 0 0.57873183 ;
	setAttr ".pt[26]" -type "float3" 0 0.14139324 0 ;
	setAttr ".pt[27]" -type "float3" 0 0 0.53893352 ;
	setAttr ".pt[28]" -type "float3" 0 0 0.53893352 ;
	setAttr ".pt[29]" -type "float3" 0 0.14139324 0 ;
	setAttr ".pt[36]" -type "float3" 0 0 0.37100339 ;
	setAttr ".pt[39]" -type "float3" 0 0 0.37100339 ;
	setAttr ".pt[78]" -type "float3" 0 0 0.57873183 ;
	setAttr ".pt[79]" -type "float3" 0 0 0.57873183 ;
	setAttr ".pt[80]" -type "float3" 0 0 0.27866688 ;
	setAttr ".pt[81]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[94]" -type "float3" 0 0.63887137 -0.16882138 ;
	setAttr ".pt[95]" -type "float3" 0 0 0.27866688 ;
	setAttr ".pt[192]" -type "float3" 0 -0.73718965 0.28345525 ;
	setAttr ".pt[193]" -type "float3" 0 0 0.45906228 ;
	setAttr ".pt[195]" -type "float3" 0 0 0.45906228 ;
	setAttr ".pt[196]" -type "float3" 0 -0.73718965 0.28345525 ;
	setAttr ".pt[207]" -type "float3" 0 0 0.40139776 ;
	setAttr ".pt[211]" -type "float3" 0 0 0.40139776 ;
	setAttr ".pt[280]" -type "float3" 0 0 0.5422014 ;
	setAttr ".pt[282]" -type "float3" 0 0 0.5422014 ;
	setAttr ".pt[415]" -type "float3" 0 0 0.14426649 ;
	setAttr ".pt[416]" -type "float3" 0 0 0.24184145 ;
	setAttr ".pt[420]" -type "float3" 0 0 0.24184145 ;
	setAttr ".pt[421]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[445]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[446]" -type "float3" 0 0 0.24184145 ;
	setAttr ".pt[450]" -type "float3" 0 0 0.24184145 ;
	setAttr ".pt[451]" -type "float3" 0 0.63887137 -0.16882138 ;
	setAttr ".pt[466]" -type "float3" 0 -0.072222672 0.00019812956 ;
	setAttr ".pt[467]" -type "float3" 0 0 -0.1201145 ;
	setAttr ".pt[479]" -type "float3" 0 0 -0.1201145 ;
	setAttr ".pt[480]" -type "float3" 0 -0.072222672 0.00019812956 ;
	setAttr ".pt[495]" -type "float3" 0 0 0.24184145 ;
	setAttr ".pt[496]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[497]" -type "float3" 0 0 0.24184145 ;
	setAttr ".pt[498]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[770]" -type "float3" 0 0 0.57873183 ;
	setAttr ".pt[774]" -type "float3" 0 0 0.57873183 ;
	setAttr ".pt[775]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[876]" -type "float3" 0 -0.25364578 -0.023773097 ;
	setAttr ".pt[877]" -type "float3" 0 0.82432711 -0.67201626 ;
	setAttr ".pt[879]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[880]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[881]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[882]" -type "float3" 0 0 -0.084555402 ;
	setAttr ".pt[892]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[893]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[894]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[895]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[897]" -type "float3" 0 0.82432711 -0.67201626 ;
	setAttr ".pt[898]" -type "float3" 0 -0.25364578 -0.023773097 ;
	setAttr ".pt[907]" -type "float3" 0 0 0.57873183 ;
	setAttr ".pt[911]" -type "float3" 0 0 0.57873183 ;
	setAttr ".pt[938]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[939]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[983]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[984]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[992]" -type "float3" 0 0 0.14426649 ;
	setAttr ".pt[993]" -type "float3" 0 0.63887137 -0.16882138 ;
	setAttr ".pt[1018]" -type "float3" 0 0.63887137 -0.16882138 ;
	setAttr ".pt[1019]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[1020]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[1021]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[1022]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[1023]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[1024]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[1025]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[1026]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[1027]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[1028]" -type "float3" 0 0.63887137 -0.16882138 ;
	setAttr ".pt[1029]" -type "float3" 0 0.63887137 -0.16882138 ;
	setAttr ".pt[1031]" -type "float3" 0 0.63887137 -0.16882138 ;
	setAttr ".pt[1058]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[1059]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[1060]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[1061]" -type "float3" 0 0 -0.084555402 ;
	setAttr ".pt[1063]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[1064]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[1066]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[1121]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[1122]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[1123]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[1125]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[1193]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[1194]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[1195]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[1196]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[1197]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[1198]" -type "float3" 0 0.63887137 -0.16882138 ;
	setAttr ".pt[1199]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[1200]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[1219]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[1220]" -type "float3" 0 0.63887137 -0.56474721 ;
	setAttr ".pt[1221]" -type "float3" 0 0.63887137 -0.53643739 ;
	setAttr ".pt[1222]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[1223]" -type "float3" 0 0 0.22882189 ;
	setAttr ".pt[1224]" -type "float3" 0 0 0.14426649 ;
	setAttr ".pt[1256]" -type "float3" 0 0.294514 0.65699285 ;
	setAttr ".pt[1257]" -type "float3" 0.43112364 0 0 ;
	setAttr ".pt[1267]" -type "float3" -0.43112364 0 0 ;
	setAttr ".pt[1268]" -type "float3" 0 0.22654922 0.5437181 ;
	setAttr ".pt[1269]" -type "float3" 0 0.24920416 0.5437181 ;
	setAttr ".pt[1270]" -type "float3" 0 0.294514 0.65699285 ;
	setAttr ".pt[1271]" -type "float3" 0 0.20389432 0.31716892 ;
	setAttr ".pt[1272]" -type "float3" 0 0.294514 0.65699285 ;
	setAttr ".pt[1273]" -type "float3" 0 0.24920416 0.5437181 ;
	setAttr ".pt[1274]" -type "float3" 0 0.24920416 0.5437181 ;
	setAttr ".pt[1275]" -type "float3" 0 0.24920416 0.5437181 ;
	setAttr ".pt[1276]" -type "float3" 0 0.22654922 0.5437181 ;
	setAttr ".pt[1277]" -type "float3" 0 0.20389432 0.31716892 ;
	setAttr ".bw" 3;
	setAttr ".dr" 1;
...
createNode displayLayerManager -n "layerManager";
	setAttr ".cdl" 7;
	setAttr -s 10 ".dli[1:9]"  1 2 3 4 8 5 6 7 
		10;
	setAttr -s 10 ".dli";
...
connectAttr "polyCut29.out" "pCubeShape1.i";
