...
//Name: muleskullmockup1.ma
//Last modified: Wed, Jan 15, 2014 12:23:07 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 50.739069716033683 27.979295029979145 50.713871302106348 ;
	setAttr ".r" -type "double3" -17.738352729551721 406.99999999982049 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 73.346605379171052;
...
createNode mesh -n "pPlaneShape2" -p "pPlane2";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 2 ".pt[0:1]" -type "float3"  0 -1.3436906e-16 -0.94224101 
		0 -1.3436906e-16 -0.94224101;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".pt";
	setAttr ".pt[50]" -type "float3" -0.28573704 -0.077654675 0 ;
	setAttr ".pt[51]" -type "float3" 0.28573704 -0.077654675 0 ;
	setAttr ".pt[56]" -type "float3" 0 -1.1920929e-07 0 ;
	setAttr ".pt[57]" -type "float3" -0.20941776 -0.027743977 -0.85253733 ;
	setAttr ".pt[58]" -type "float3" 0.23936005 -0.027743977 -0.85253733 ;
	setAttr ".pt[59]" -type "float3" 0.014971159 -0.027743977 -0.85253733 ;
